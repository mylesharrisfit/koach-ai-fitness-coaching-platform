...
const TIER_HIGHLIGHTS = {
  ...
  pro:        ['Up to 25 clients', 'Everything in Starter', 'Unlimited AI program builder', 'Unlimited AI meal plan builder', 'Progress analytics & graphs', 'Check-in review system', 'Adherence scoring', 'Voice & video messages', 'Client mobile dashboard', 'AI reply suggestions', 'Custom branding (logo)', 'Priority email support'],
  elite:      ['Up to 75 clients', 'Everything in Pro', 'Full AI Assistant — auto progression, check-in analysis & coaching automation', 'Sales pipeline CRM', 'Revenue dashboard', 'White-label branding', 'Community module', 'Zapier integrations', 'Chat support'],
