...
import { Users, UserPlus, Mail, Crown, Check, Clock, X, Loader2 } from 'lucide-react';
...
function MemberRow({ member, isYou, onRemove, canRemove }) {
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          ...
          {!isLoading && sortedMembers.map(member => (
            <MemberRow
              ...
              canRemove={member.role_label !== 'owner'}
            />
          ))}
        </div>
      )}
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4">
          ...
          <div className="space-y-1.5">
            {[
              ...
              'All coaches currently share the same data view — permissions coming soon.',
            ].map((step, i) => (
