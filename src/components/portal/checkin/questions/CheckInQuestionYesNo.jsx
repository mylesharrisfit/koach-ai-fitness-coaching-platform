  ...
  return (
    <div className="space-y-4">
      <div className="flex gap-4">
        {[
          { val: 'yes', label: 'Yes', emoji: '✅', color: '#22C55E', bg: 'rgba(34,197,94,0.15)', border: 'rgba(34,197,94,0.4)' },
          { val: 'no', label: 'No', emoji: '❌', color: '#EF4444', bg: 'rgba(239,68,68,0.15)', border: 'rgba(239,68,68,0.4)' },
        ].map(opt => (
