      ...
      <AnimatePresence>
        {showDelete && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
            ...
            <p className="text-white/50 text-xs mb-3">This will permanently delete all your data including check-ins, progress, and messages. Type <span className="text-destructive font-bold">DELETE</span> to confirm.</p>
            <input
              className="w-full bg-transparent text-white text-sm outline-none border border-destructive/30 rounded-xl px-3 py-2 mb-3"
