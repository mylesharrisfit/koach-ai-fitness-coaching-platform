                ...
                <div key={day} className={cn(
                  ...
                  {workout ? (
                    <div>
                      ...
                      <p className="text-[10px] text-foreground mt-0.5">{workout.exercises.filter(e => e.name).length} exercises</p>
                    ...
                    <p className="text-[10px] text-foreground/40 text-center mt-4">Rest</p>
                  )}
                </div>
              );
            })}
                  ...
                  {workout.exercises.filter(e => e.name).map((ex, eIdx) => (
                    <div key={eIdx} className="flex items-center gap-3 px-4 py-2">
                      ...
                      <div className="flex items-center gap-3 text-xs text-foreground">
                        ...
                        {ex.tempo && <span className="text-foreground font-mono">{ex.tempo}</span>}
