      ...
      <DialogContent className="max-w-md">
        ...
        {zoomConnected ? (
          <div className="space-y-4 mt-1">
            ...
            <div className="flex items-center gap-2 p-3 bg-emerald-50 border border-emerald-100 rounded-xl">
              ...
              <div>
                ...
                {settings?.zoom_user_email && (
                  <p className="text-xs text-emerald-600">{settings.zoom_user_email}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl border border-[#E7EAF3] bg-[#F9FAFB]">
              <div>
                <p className="text-sm font-semibold text-[#111827]">Waiting Room</p>
                <p className="text-xs text-[#6B7280]">Clients wait until you admit them</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl border border-[#E7EAF3] bg-[#F9FAFB]">
              <div>
                <p className="text-sm font-semibold text-[#111827]">Auto-record Sessions</p>
                <p className="text-xs text-[#6B7280]">Automatically record to Zoom cloud</p>
              </div>
          ...
          <div className="space-y-4 mt-1">
            ...
            <div className="bg-[#F0F7FF] border border-blue-100 rounded-xl p-4">
              <p className="text-xs font-semibold text-[#1D4ED8] mb-2">Setup Instructions</p>
