...
export default function PageHeader({ title, subtitle, actions }) {
  return (
    <div className="flex flex-col gap-3 mb-6 md:mb-8 fade-up sm:flex-row sm:items-center sm:justify-between">
      <div>
        <h1 className="text-xl sm:text-3xl font-heading font-bold tracking-tight leading-tight text-[#1F2A44]">{title}</h1>
        {subtitle && <p className="text-[#6B7280] mt-1 text-sm leading-relaxed">{subtitle}</p>}
      </div>
