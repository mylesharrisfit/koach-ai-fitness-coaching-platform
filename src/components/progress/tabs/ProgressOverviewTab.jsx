  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          onClick={() => {
            base44Legacy.integrations.Core.SendEmail({ to: client.email, subject: '🎉 You\'re crushing it!', body: `Hi ${client.name}! Your coach wants to celebrate your progress. Keep up the amazing work! 💪` }).then(() => toast.success('Celebration message sent!')).catch(() => toast.error('Could not send message'));
          }}
