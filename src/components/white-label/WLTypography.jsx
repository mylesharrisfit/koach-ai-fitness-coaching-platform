      ...
      <WLRow label="Preview">
        <div className="p-5 rounded-xl bg-muted border border-border">
          ...
          <div className="flex gap-2 mt-3">
            <button className="px-4 py-2 rounded-xl text-sm font-semibold text-primary-foreground" style={{ fontFamily: font, fontWeight: 600, background: s.primary_color || 'var(--tc-primary)' }}>
              Start Workout
            </button>
