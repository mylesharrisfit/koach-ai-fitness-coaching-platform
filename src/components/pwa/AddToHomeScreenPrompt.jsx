      ...
      <motion.div
        ...
        <div className="w-full bg-white rounded-t-[28px] pt-8 pb-8 px-5 shadow-2xl">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm mt-1">Look for the <Share2 className="w-3.5 h-3.5 inline" /> icon at the bottom of Safari</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 font-black text-white"
                style={{ background: '#2563EB' }}>2</div>
              <div>
                <p className="font-bold text-slate-900">Tap "Add to Home Screen"</p>
                <p className="text-slate-500 text-sm mt-1">Scroll down and find this option in the menu</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 font-black text-white"
                style={{ background: '#2563EB' }}>3</div>
              <div>
                <p className="font-bold text-slate-900">Tap "Add"</p>
                <p className="text-slate-500 text-sm mt-1">KOACH AI will appear on your home screen instantly</p>
              </div>
            </div>
          </motion.div>
