...
const DEFAULT_FOODS = [
  { name: 'Chicken Breast', category: 'Protein',    serving_size: 100, serving_unit: 'g',  calories: 165, protein: 31,  carbs: 0,  fats: 3.6, is_custom: false },
  { name: 'Rolled Oats',    category: 'Carbs',      serving_size: 100, serving_unit: 'g',  calories: 389, protein: 17,  carbs: 66, fats: 7,   is_custom: false },
  { name: 'White Rice',     category: 'Carbs',      serving_size: 100, serving_unit: 'g',  calories: 130, protein: 2.7, carbs: 28, fats: 0.3, is_custom: false },
  { name: 'Whole Eggs',     category: 'Protein',    serving_size: 50,  serving_unit: 'g',  calories: 78,  protein: 6,   carbs: 0.6,fats: 5,   is_custom: false },
  { name: 'Salmon',         category: 'Protein',    serving_size: 100, serving_unit: 'g',  calories: 208, protein: 20,  carbs: 0,  fats: 13,  is_custom: false },
  { name: 'Broccoli',       category: 'Vegetables', serving_size: 100, serving_unit: 'g',  calories: 34,  protein: 2.8, carbs: 7,  fats: 0.4, is_custom: false },
  { name: 'Sweet Potato',   category: 'Carbs',      serving_size: 100, serving_unit: 'g',  calories: 86,  protein: 1.6, carbs: 20, fats: 0.1, is_custom: false },
  { name: 'Greek Yogurt',   category: 'Dairy',      serving_size: 170, serving_unit: 'g',  calories: 100, protein: 17,  carbs: 6,  fats: 0.7, is_custom: false },
  { name: 'Almonds',        category: 'Fats',       serving_size: 28,  serving_unit: 'g',  calories: 164, protein: 6,   carbs: 6,  fats: 14,  is_custom: false },
  { name: 'Banana',         category: 'Fruits',     serving_size: 118, serving_unit: 'g',  calories: 105, protein: 1.3, carbs: 27, fats: 0.4, is_custom: false },
  { name: 'Olive Oil',      category: 'Fats',       serving_size: 14,  serving_unit: 'ml', calories: 119, protein: 0,   carbs: 0,  fats: 14,  is_custom: false },
  { name: 'Beef Mince',     category: 'Protein',    serving_size: 100, serving_unit: 'g',  calories: 215, protein: 26,  carbs: 0,  fats: 12,  is_custom: false },
  { name: 'Cottage Cheese', category: 'Dairy',      serving_size: 113, serving_unit: 'g',  calories: 90,  protein: 13,  carbs: 5,  fats: 2.5, is_custom: false },
  { name: 'Whey Protein',   category: 'Protein',    serving_size: 30,  serving_unit: 'g',  calories: 120, protein: 24,  carbs: 3,  fats: 1.5, is_custom: false },
  { name: 'Spinach',        category: 'Vegetables', serving_size: 100, serving_unit: 'g',  calories: 23,  protein: 2.9, carbs: 3.6,fats: 0.4, is_custom: false },
  { name: 'Avocado',        category: 'Fats',       serving_size: 100, serving_unit: 'g',  calories: 160, protein: 2,   carbs: 9,  fats: 15,  is_custom: false },
  { name: 'Quinoa',         category: 'Carbs',      serving_size: 100, serving_unit: 'g',  calories: 120, protein: 4.4, carbs: 22, fats: 1.9, is_custom: false },
  { name: 'Tuna (canned)',  category: 'Protein',    serving_size: 100, serving_unit: 'g',  calories: 116, protein: 25,  carbs: 0,  fats: 1,   is_custom: false },
  { name: 'Whole Milk',     category: 'Dairy',      serving_size: 240, serving_unit: 'ml', calories: 149, protein: 8,   carbs: 12, fats: 8,   is_custom: false },
  { name: 'Peanut Butter',  category: 'Fats',       serving_size: 32,  serving_unit: 'g',  calories: 190, protein: 7,   carbs: 7,  fats: 16,  is_custom: false },
];
