...
const UserNotRegisteredError = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen" style={{ background: 'rgb(var(--sidebar))' }}>
      <div className="max-w-md w-full p-8 rounded-2xl" style={{ background: '#161616', border: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="text-center">
          ...
          <p className="text-xs uppercase tracking-[0.2em] font-semibold mb-2" style={{ color: 'rgb(var(--primary))' }}>KOACH AI</p>
