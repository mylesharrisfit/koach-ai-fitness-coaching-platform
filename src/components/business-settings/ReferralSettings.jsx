  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl p-6 border border-slate-200">
        <h3 className="text-slate-900 font-black text-lg mb-4">Referral Program</h3>

        {/* Enable/Disable */}
        <div className="mb-6 flex items-center justify-between">
          <div>
            <p className="font-semibold text-slate-900">Enable Client Referral Program</p>
            <p className="text-slate-500 text-sm mt-1">Let clients refer friends and earn rewards</p>
          </div>
          <button
            onClick={() => setSettings({ ...settings, is_enabled: !settings.is_enabled })}
            className={`w-12 h-7 rounded-full transition-colors ${
              settings.is_enabled ? 'bg-blue-600' : 'bg-slate-300'
            }`}
            style={{
        ...
        {settings.is_enabled && (
          <>
            {/* Reward Type */}
            <div className="mb-6">
              <label className="block font-semibold text-slate-900 mb-2">Reward Type</label>
              <select
            ...
            {/* Reward Amount */}
            <div className="mb-6">
              <label className="block font-semibold text-slate-900 mb-2">Reward Amount</label>
            ...
            {/* Trigger */}
            <div className="mb-6">
              <label className="block font-semibold text-slate-900 mb-2">When Is Reward Given?</label>
              <select
            ...
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="font-semibold text-slate-900">Also reward the referred friend</p>
                <p className="text-slate-500 text-sm mt-1">Give new clients an incentive to join</p>
              </div>
              <button
            ...
            {settings.reward_referred_friend_too && (
              <div className="mb-6">
                <label className="block font-semibold text-slate-900 mb-2">What do new clients get?</label>
                <input
                  type="text"
            ...
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="font-semibold text-slate-900">Auto-apply rewards</p>
                <p className="text-slate-500 text-sm mt-1">Rewards automatically applied when earned</p>
              </div>
              <button
            ...
            {/* Message */}
            <div className="mb-6">
              <label className="block font-semibold text-slate-900 mb-2">Message to Clients</label>
              <textarea
