...
function MiniRecRow({ rec, checkIn, client }) {
  ...
  const handleCancel = (e) => { e.stopPropagation(); setStage('idle'); };
      ...
      <div className="flex items-center gap-3 px-3 py-2.5">
        ...
        {stage === 'idle' && (
          <button
            ...
            className="flex-shrink-0 flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-semibold border bg-primary/8 border-primary/20 text-primary hover:bg-primary/15 transition-colors whitespace-nowrap"
          >
